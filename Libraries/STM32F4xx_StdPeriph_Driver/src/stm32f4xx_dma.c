...
/**
  * @brief  Checks whether the specified DMAy Streamx flag is set or not. 检查是否设置了指定的DMAy Streamx标志。
  * @param  DMAy_Streamx: where y can be 1 or 2 to select the DMA and x can be 0 其中y可以是1或2来选择DMA，x可以是0到7选择DMA流。
  *          to 7 to select the DMA Stream.
